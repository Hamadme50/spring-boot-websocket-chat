...
<head>
    ...
    <link  href="/content/lib/app/responsive.css?v=${cache}" type="text/css" rel="stylesheet" >
...
<div id="mainchat" class="mainchat" style="float: left;z-index:50;height: calc(100% - 80px) !important;width: 80%;overflow: hidden">
...
<div id="chat_users" class="border-left rightside" style="float: left;z-index:1;height: calc(100% - 80px) !important;width: 20%;overflow: hidden">
    ...
    <div id="mainInpurArea" style="height: 40px;width: 100%;" >
        <table style="width:100%;text-align: center;">
            <tr >
                ...
                <td style="padding-top: 7px;width: 30px;" class="clIconUsers" onclick="openUserList()">
                    <i class="fa-solid fa-user-group" style="font-size: 22px;padding-right: 10px;padding-left: 10px;"></i>
                </td>
