...
<main class="form-signin">
    ...
    <form style="text-align: center;margin-top: 5px;" action="/panel/signin" method="post">
        <span style=" font-size: 12px;" >have password ? <input type="submit"  class="transparent" style="font-weight: bold; color: #0c5460" value="Sign In" /> </span>
    </form>
</main>
